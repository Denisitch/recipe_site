...
environ.Env.read_env(env_file=str(os.path.dirname(BASE_DIR)) + "/.env")
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "apps/recipes/templates/recipes"),
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "apps/recipes/static"),
]
